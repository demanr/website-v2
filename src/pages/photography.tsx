    ...
    <div className="px-8 py-8 font-serif text-6xl">
      <div className="px-2">
        ...
        <div className="w-full max-w-2xl pt-4 pb-8 text-xl opacity-60">
          {/* I've always loved sunsets. As a kid, I'd rush to finish my supper to
          go take pictures of the sunset over the lake. Or even ask to leave
          midway through a meal, "Just for a minute! Look outside- its perfect!
          I need to go now!" filling my iPod storage in no time. */}
        </div>
      </div>
