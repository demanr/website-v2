      ...
      <div className="w-full overflow-x-auto">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 min-w-max">
          <div className="flex items-center justify-between w-full gap-8 py-4 lg:gap-16">
            <div className="text-4xl font-bold text-white transition xl:text-6xl lg:text-5xl md:text-4xl text-md">
              RACHELLE DE MAN
            </div>
            {/* Socials */}
            <div className="flex space-x-4 text-white transition md:space-x-8 xl:text-lg lg:text-md">
              <a
